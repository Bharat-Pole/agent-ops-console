...
async def _bigquery_schema(service_account_json: str) -> dict[str, list[dict[str, str]]]:
    from app.services.ingestion.bigquery_fetcher import _run_query_sync
...
async def _generate_sql_text(prompt: str, llm_provider: str) -> str:
    if llm_provider == "groq":
        from app.services.groq_service import is_groq_configured, generate_text
    ...
    from app.services.claude_service import is_claude_configured, _get_client, MODEL_BY_TIER
