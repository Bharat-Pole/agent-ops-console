...
from app.services.ingestion.parsers import fetch_url, parse_by_mime
...
async def _fetch(source: dict[str, Any], source_id: str) -> tuple[bytes, str]:
    ...
    if source_type == "text":
        ...
        from app.services.ingestion.db_fetcher import fetch_database_query
        ...
        from app.services.ingestion.confluence_fetcher import fetch_confluence
        ...
        from app.services.ingestion.jira_fetcher import fetch_jira
        config = await _load_connector_config(source_id)
        ...
        from app.services.ingestion.github_fetcher import fetch_github
        config = await _load_connector_config(source_id)
        ...
        from app.services.ingestion.servicenow_fetcher import fetch_servicenow
        config = await _load_connector_config(source_id)
        ...
        from app.services.ingestion.bigquery_fetcher import fetch_bigquery
        config = await _load_connector_config(source_id)
