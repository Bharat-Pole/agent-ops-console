...
export const api = {
  ...
  updateRiskTier: services.updateRiskTier,
  suggestSources: services.suggestSources,
  enableDemoMode: services.enableDemoMode,
  chatWithAgent: services.chatWithAgent,
  createPrompt: services.createPrompt,
  generatePromptBody: services.generatePromptBody,
  newPromptVersion: services.newPromptVersion,
  ...
  deleteModel: services.deleteModel,
  updatePolicyRule: services.updatePolicyRule,
  updatePathDefinition: services.updatePathDefinition,
  grantException: services.grantException,
  revokeException: services.revokeException,
  downloadEvidencePack: services.downloadEvidencePack,
  promoteDeployment: services.promoteDeployment,
  rollbackDeployment: services.rollbackDeployment,
  grantAccess: services.grantAccess,
  revokeAccess: services.revokeAccess,
  setFeatureFlag: services.setFeatureFlag,
  updateA2AEndpoint: services.updateA2AEndpoint,
